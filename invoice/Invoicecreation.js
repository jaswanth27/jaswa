...
import {
  ...
  TextInput,
  TouchableOpacity,
  Button,Alert,ScrollView,ImageBackground
} from 'react-native';
...
const onChangeinvoice = (value) => {
  ...
  async function saveData2() {
    //await fetch('https://lbkautospa.com/kryptos/qb/qb/crud/Invoice/InvoiceCreate.php', {
      //await fetch('https://lbkautospa.com/kryptos/qb/qb/crud/Invoice/Oauth4.php'
      await fetch('https://lbkautospa.com/kryptos/qb/qb/crud/Invoice/Qbcreate.php'
      , {
   method: 'POST',
   body: JSON.stringify(
     {
 ...
 <View style={{backgroundColor:"white"}}>
      <TouchableOpacity onPress={saveData}>
        <View style={{ backgroundColor: 'green', padding: 10 ,color:"red"}}>
          ...
          <Text style={{ color: 'white', textAlign: 'center'}}>CREATEINVOICE</Text>
      ...
      <TouchableOpacity onPress={saveData2}>
        <View style={{ backgroundColor: 'green', padding: 10 ,color:"red"}}>
          ...
          <Text style={{ color: 'white', textAlign: 'center'}}>QUICKBOOKS</Text>
